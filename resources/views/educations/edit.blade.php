...
<div class="container">
    ...
    <form method="post" action="/console/educations/edit/{{$education->id}}" novalidate class="w3-margin-bottom">
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="text" name="school" id="school" value="{{old('school', $education->school)}}">
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="date" name="date" id="date" value="{{old('date', $education->date)}}">
        ...
        <div class="w3-margin-bottom">
            ...
            <input type="text" name="course" id="course" value="{{old('course', $education->course)}}" required>
        ...
        <button type="submit" class="addBtn">Edit Education</button>
