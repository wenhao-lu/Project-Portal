...
<section>
    <div class="container">
    <h2 class="title">Add Showcase</h2>

    <form method="post" action="/console/showcases/add" novalidate class="w3-margin-bottom">
        ...
        <button type="submit" class="addBtn">Add Showcase</button>
